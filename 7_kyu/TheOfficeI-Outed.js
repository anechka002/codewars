...
function outed(meet, boss){
  ...
  const double = meet[boss] * 2
  let sum = values.reduce((acc, el) => acc + el, 0) - meet[boss] + double
...
console.log(outed({"tim":3,"jim":6,"randy":8,"sandy":2,"andy":6,"katie":5,"laura":9,"saajid":2,"alex":2,"john":1,"mr":8}, 'mr'))