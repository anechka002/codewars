...
function getCard() {
  function generateColumn(letter, min, max, count) {
    const numbers = []
  ...
  return [
    ...generateColumn('B', 1, 15, 5),
    ...generateColumn('I', 16, 30, 5),
    ...generateColumn('N', 31, 45, 4),
    ...generateColumn('G', 46, 60, 5),
    ...generateColumn('O', 61, 75, 5),
  ]
}
console.log(getCard())